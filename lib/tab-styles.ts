...
export const iosTabItem =
  'flex min-h-11 min-w-0 flex-1 flex-col items-center justify-center gap-0.5 rounded-full px-0.5 py-1.5 text-[9px] font-bold uppercase leading-tight tracking-normal transition-all duration-300 active:scale-90'
