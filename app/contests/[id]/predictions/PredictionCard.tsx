...
function ScoreStepper({
  ...
  const btn =
    'inline-flex h-11 w-11 touch-manipulation items-center justify-center rounded-md transition-colors duration-300 active:scale-90 disabled:opacity-25 sm:h-5 sm:w-7'
  return (
...
export default function PredictionCard({
  ...
  return (
    <div
      className={cn(
        'prediction-fixture-content mb-2.5 touch-manipulation overflow-hidden rounded-2xl border border-emerald-100 bg-emerald-500/5 px-2.5 py-2 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:mb-0 dark:border-white/10 dark:shadow-none',
