  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div className="mb-2 flex items-center gap-3">
        ...
        <div>
          <h2 className="text-2xl font-black uppercase tracking-tight text-gray-900">Contest Settings</h2>
          <p className="text-gray-500 text-sm mt-0.5">Manage your league details, rules, and invites.</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white p-6 md:p-8 rounded-2xl border border-gray-200 shadow-lg">
          <h3 className="text-lg font-extrabold uppercase tracking-tight text-gray-900 mb-4">League Details</h3>
        ...
        <div className="bg-white p-6 md:p-8 rounded-2xl border border-gray-200 shadow-lg">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-lg font-extrabold uppercase tracking-tight text-gray-900">Scoring System</h3>
          </div>
          <p className="text-xs text-gray-500 mb-6 leading-relaxed">
            Customize the points awarded. Exact and Result must be whole numbers. Close can use 0.5 increments. <strong className="text-gray-800">Maximum 5 points per category.</strong>
          </p>
          ...
          <form action={updateScoringSettings} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-700 mb-1">Exact Score</label>
              ...
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-700 mb-1">Close Prediction</label>
                <input type="number" step="0.5" min="0" max="5" name="points_close" defaultValue={contest.points_close ?? 1.5} required
                  className="w-full rounded-xl px-4 py-3 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500 font-mono bg-gray-50 font-bold" />
              </div>
              
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-700 mb-1">Correct Result</label>
        ...
        <div className="bg-white p-6 md:p-8 rounded-2xl border border-gray-200 shadow-lg border-l-4 border-l-orange-500">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-lg font-extrabold uppercase tracking-tight text-gray-900">Secret Invite Key</h3>
          </div>
          ...
          <div className="bg-gray-950 text-white p-6 rounded-2xl border border-gray-800 text-center mb-6 shadow-inner">
            <span className="text-[10px] text-gray-400 font-black uppercase tracking-widest block mb-2">Current Active Key</span>
